...
class ServicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'title_ar.required' => 'اسم الخدمة بالعربية مطلوب',
            'title_en.required' => 'اسم الخدمة بالإنجليزية مطلوب',
            'description_ar.required' => 'وصف الخدمة بالعربية مطلوب',
            'description_en.required' => 'وصف الخدمة بالإنجليزية مطلوب',
            'slug.required' => 'الرابط المختصر مطلوب',
            'slug.unique' => 'الرابط المختصر مستخدم بالفعل',
            'image.image' => 'حقل الصورة يجب أن يكون صورة صالحة',
            'gallery_images.array' => 'صور الجاليري غير صحيحة',
            'gallery_images.*.image' => 'صور الجاليري يجب أن تكون صور',
            'features_ar.required' => 'مميزات الخدمة بالعربية مطلوبة',
            'features_en.required' => 'مميزات الخدمة بالإنجليزية مطلوبة',
            'featured.boolean' => 'الحقل يجب أن يكون true أو false',
            'sort_order.integer' => 'الترتيب يجب أن يكون رقم',
        ...
        if (!array_key_exists('image', $validated) || $validated['image'] === null) {
            $validated['image'] = 'assets/img/photos/1.jpg';
        }
