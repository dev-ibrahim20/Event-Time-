                    ...
                    <div class="col-xl-12">
                        <div class="card mg-b-20">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">تعديل الوظيفة</h4>
                                <i class="mdi mdi-dots-horizontal text-gray"></i>
                            </div>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin-careers.update', $admin_career->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title_ar" id="title_ar" class="form-control @error('title_ar') is-invalid @enderror" 
                                                       value="{{ old('title_ar', $admin_career->title_ar) }}" required>
                                                @error('title_ar')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title_en" id="title_en" class="form-control @error('title_en') is-invalid @enderror" 
                                                       value="{{ old('title_en', $admin_career->title_en) }}" required>
                                                @error('title_en')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="requirements_ar" id="requirements_ar" class="form-control @error('requirements_ar') is-invalid @enderror" 
                                                          rows="6" required>{{ old('requirements_ar', $admin_career->requirements_ar) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="requirements_en" id="requirements_en" class="form-control @error('requirements_en') is-invalid @enderror" 
                                                          rows="6" required>{{ old('requirements_en', $admin_career->requirements_en) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="sort_order" id="sort_order" class="form-control @error('sort_order') is-invalid @enderror" 
                                                       value="{{ old('sort_order', $admin_career->sort_order) }}" min="0">
                                                @error('sort_order')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="status" id="status" class="custom-control-input" value="1" {{ old('status', $admin_career->status) ? 'checked' : '' }}>
