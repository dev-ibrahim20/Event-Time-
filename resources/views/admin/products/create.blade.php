                    ...
                    <div class="col-xl-12">
                        <div class="card mg-b-20">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">إضافة منتج جديد</h4>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="category_ar" id="category_ar" class="form-control @error('category_ar') is-invalid @enderror" 
                                                       value="{{ old('category_ar') }}" placeholder="مثال: إلكترونيات، ملابس">
                                                @error('category_ar')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="category_en" id="category_en" class="form-control @error('category_en') is-invalid @enderror" 
                                                       value="{{ old('category_en') }}" placeholder="Example: Electronics, Clothes">
                                                @error('category_en')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description_ar" id="description_ar" class="form-control @error('description_ar') is-invalid @enderror" 
                                                          rows="6" required>{{ old('description_ar') }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description_en" id="description_en" class="form-control @error('description_en') is-invalid @enderror" 
                                                          rows="6" required>{{ old('description_en') }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="featured" id="featured" class="custom-control-input" value="1">
